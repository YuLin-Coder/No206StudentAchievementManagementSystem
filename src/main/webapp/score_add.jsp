...
<div class="container-fluid">
    ...
    <br/>
    <form class="form-horizontal" role="form" action="scoreAdd" method="post" onsubmit="return check()">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <input name="scoreSex" type="radio" value="男" checked="checked"/>&nbsp;&nbsp;&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;
                <input name="scoreSex" type="radio" value="女"/>&nbsp;&nbsp;&nbsp;女&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">班级：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" id="scoreClass" name="scoreClass">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">学科：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" id="scoreSubject" name="scoreSubject">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">教师：</label>
            <div class="col-sm-5">
                <input type="text" class="form-control" id="scoreTeacher" name="scoreTeacher">
            </div>
        </div>
        <div class="form-group">
